...
```bash
curl -L https://github.com/Mr-Jackal/Copilot-Quota-Monitor/releases/download/v0.0.1/copilot-quota-monitor-0.0.1.vsix -o copilot-quota-monitor.vsix && code --install-extension copilot-quota-monitor.vsix && del copilot-quota-monitor.vsix
```

**macOS / Linux:**
```bash
curl -L https://github.com/Mr-Jackal/Copilot-Quota-Monitor/releases/download/v0.0.1/copilot-quota-monitor-0.0.1.vsix -o copilot-quota-monitor.vsix && code --install-extension copilot-quota-monitor.vsix && rm copilot-quota-monitor.vsix
```

### Quick Install (Recommended)

1. **Download** the latest `.vsix` file from the [Releases](https://github.com/Mr-Jackal/Copilot-Quota-Monitor/releases) page
2. Open VS Code
...
```bash
git clone https://github.com/Mr-Jackal/Copilot-Quota-Monitor.git
